...
# - Digital signatures
# - Biometric data
# - Email addresses (if they'd permit access to financial accounts)

# Map of Presidio entity types to NC breach notification categories
NC_BREACH_ENTITIES = {
    ...
    'NRP': 'Potentially PII'  # Named Recognition Pattern - could be various entity types
}
...
def report_high_risk_files(high_risk_files):
    print(f"Files containing high-confidence PII requiring breach notification under NC law:\n")
...
if __name__ == '__main__':
    ...
    if high_risk_files:
        ...
        print("breach notification under North Carolina law for local governments.")
    else:
